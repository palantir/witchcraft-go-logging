...
func AuditSuccess(ctx context.Context, msg stringConst, params ...Param) {
	FromContext(ctx).Success(string(msg), params...)
}

func AuditUnauthorized(ctx context.Context, msg stringConst, params ...Param) {
	FromContext(ctx).Unauthorized(string(msg), params...)
}

func AuditError(ctx context.Context, msg stringConst, params ...Param) {
	FromContext(ctx).Error(string(msg), params...)
}
