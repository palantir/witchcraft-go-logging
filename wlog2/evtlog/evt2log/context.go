...
func Event(ctx context.Context, msg stringConst, params ...Param) {
	FromContext(ctx).Event(string(msg), params...)
}
...
func FromContext(ctx context.Context) Logger {
	...
	var params []Param
	if paramStorer := wparams.ParamStorerFromContext(ctx); paramStorer != nil {
