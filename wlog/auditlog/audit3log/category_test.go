...
func TestCategory(t *testing.T) {
	...
	logger.Audit("TEST_ENTRY", AuditResultSuccess, categoryParam)
...
func TestMultiCategory(t *testing.T) {
	...
	logger.Audit("TEST_ENTRY", AuditResultSuccess, appConfigSearchCategoryParams, containerSearchCategoryParams)
