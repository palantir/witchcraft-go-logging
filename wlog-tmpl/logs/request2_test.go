...
func TestRequest2Logs(t *testing.T) {
	RunLogTests(t, []LogTest{
		...
		},
		{
			...
			input: []string{
				`{"type":"request.2","time":"2017-05-08T21:34:03.571Z","method":"GET","protocol":"HTTP/2.0","path":"/long/{id}","params":{"accept-encoding":"gzip","host":"localhost:8443","user-agent":"okhttp/3.5.0"},"status":200,"requestSize":0,"responseSize":108,"duration":68000,"uid":null,"sid":null,"tokenId":null,"orgId":null,"traceId":"d384560e01f9a657","unsafeParams":{"unsafeKey":"unsafeVal","id":"unsafeId"}}`,
			},
			output: []string{
		...
		},
		{
			...
			input: []string{
				`{"type":"request.2","time":"2017-05-08T21:34:03.571Z","protocol":"HTTP/2.0","path":"/long","params":{"accept-encoding":"gzip","host":"localhost:8443","user-agent":"okhttp/3.5.0"},"status":200,"requestSize":0,"responseSize":108,"duration":68000,"uid":null,"sid":null,"tokenId":null,"orgId":null,"traceId":"d384560e01f9a657","unsafeParams":{"unsafeKey":"unsafeVal"}}`,
			},
			output: []string{
		...
		},
		{
			...
			input: []string{
				`{"type":"request.2","time":"2017-05-08T21:34:03.5Z","method":"GET","protocol":"HTTP/2.0","path":"/long","params":{"accept-encoding":"gzip","host":"localhost:8443","user-agent":"okhttp/3.5.0"},"status":200,"requestSize":0,"responseSize":108,"duration":68000,"uid":null,"sid":null,"tokenId":null,"orgId":null,"traceId":"d384560e01f9a657","unsafeParams":{"unsafeKey":"unsafeVal"}}`,
				`{"type":"request.2","time":"2017-05-08T21:34:03.57Z","method":"GET","protocol":"HTTP/2.0","path":"/long","params":{"accept-encoding":"gzip","host":"localhost:8443","user-agent":"okhttp/3.5.0"},"status":200,"requestSize":0,"responseSize":108,"duration":68000,"uid":null,"sid":null,"tokenId":null,"orgId":null,"traceId":"d384560e01f9a657","unsafeParams":{"unsafeKey":"unsafeVal"}}`,
				`{"type":"request.2","time":"2017-05-08T21:34:03.571Z","method":"GET","protocol":"HTTP/2.0","path":"/long","params":{"accept-encoding":"gzip","host":"localhost:8443","user-agent":"okhttp/3.5.0"},"status":200,"requestSize":0,"responseSize":108,"duration":68000,"uid":null,"sid":null,"tokenId":null,"orgId":null,"traceId":"d384560e01f9a657","unsafeParams":{"unsafeKey":"unsafeVal"}}`,
